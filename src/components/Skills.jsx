...
const skillGroups = [
  {
    ...
    categoryId: 'sg-design-prototyping',
    icon: (
  ...
  },
  {
    ...
    categoryId: 'sg-accessibility-qa',
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" aria-hidden="true" focusable="false">
  ...
  },
  {
    ...
    categoryId: 'sg-frontend-development',
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" aria-hidden="true" focusable="false">
  ...
  },
  {
    ...
    categoryId: 'sg-ux-process-research',
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" aria-hidden="true" focusable="false">
  ...
  <section id="skills" className="skills" aria-labelledby="skills-heading">
    <div className="section-inner">
      ...
      <p className="skills__subheading">
        A full-spectrum skill set spanning product design, WCAG accessibility
        engineering, React.js front-end development, Figma Design Systems, and
        strategic UX research — deployable across enterprise B2B and
        high-traffic B2C environments.
      </p>
      ...
      <div className="skills__grid">
        {skillGroups.map((group) => (
          <div
            ...
            aria-labelledby={group.categoryId}
          >
            <div className="skill-group__header">
              <span className="skill-group__icon" aria-hidden="true">
                {group.icon}
              </span>
              <h3 id={group.categoryId} className="skill-group__title">
                {group.category}
              </h3>
            </div>
            ...
            >
              {group.skills.map((s) => (
                <li key={s.name} className="skill-item">
                  ...
                  {/*
                    role="progressbar" with aria-valuenow/min/max/label
                    correctly communicates proficiency to screen readers.
                  */}
                  <div
      ...
      <div className="skills__tools" aria-label="Tools and platforms">
        <div className="skills__tools-label" aria-hidden="true">
          Tools &amp; Platforms
        </div>
        <ul className="skills__tools-list" aria-label="Tools and platforms list">
          {toolLogos.map((t) => (
