...
const experiences = [
  {
    ...
    current: true,
    description:
      'Architecting accessible UI systems for clients including Sookti AI, Crazyeggz, Pratual Solar Power, and Bharat Rover using React.js, SCSS, and Figma Design Systems with full WCAG 2.1 AA compliance and accessibility token integration.',
    highlights: [
  ...
  },
  {
    ...
    current: false,
    description:
      'Spearheaded end-to-end UX strategy for 3+ enterprise digital products. Championed accessibility-first initiatives, established scalable Figma Design Systems, and mentored a team of 6 designers and developers.',
    highlights: [
    ...
    tags: ['Enterprise UX', 'Design Systems', 'DesignOps', 'Accessibility', 'Mentoring', 'Figma', 'Pimore', 'Adobe Creative Suite', 'Newsletter/Emailer'],
  ...
  },
  {
    ...
    current: false,
    description:
      'Built 30+ accessible UI components with React.js, Redux, and SCSS. Created a Figma Design System library with WCAG 2.1 AA tokens. Ran moderated usability tests to validate interaction design before each release.',
    highlights: [
    ...
    tags: ['Figma', 'Usability Testing', 'A/B Testing', 'React.js', 'Redux'],
  },
  {
    ...
    current: false,
    description:
      'Designed and developed Dabur brand websites with combined 50M+ monthly visitors. Executed Lighthouse audits and performance remediation. Delivered pixel-perfect responsive patterns across 8+ device form factors.',
    highlights: [
  ...
  },
  {
    ...
    current: false,
    /*
     * NOTE: description is plain text here (not JSX) to keep array data
     * serializable and avoid React key warnings. Rich formatting is done
     * in the render below via a dedicated EarlyCareerDesc component.
     */
    description:
      'Freelance Web & Graphic Designer · Web Developer at Moretimer Pvt Ltd · E-Learning Product Developer at Infopro India (Oracle Global E-Learning Platform — SCORM/xAPI, Articulate Storyline/Rise, Captivate)',
    highlights: [
      ...
      <ol className="timeline" aria-label="Career experience timeline">
        {experiences.map((exp) => (
          <li
            ...
            className={`timeline__item ${exp.current ? 'timeline__item--current' : ''}`}
          >
            ...
            <div className="timeline__content">
              <header className="timeline__header">
                <div className="timeline__role-row">
                  ...
                  {exp.current && (
                    <span
                      className="timeline__current-badge"
              ...
              {exp.awards && (
                <div className="timeline__awards" aria-label="Awards received">
                  {exp.awards.map((a) => (
              ...
              <ul className="timeline__tags" aria-label="Skills used">
                {exp.tags.map((t) => (
                  <li key={t} className="timeline__tag">
                    {t}
                  </li>
                ))}
              </ul>
