    ...
    fullStudy: [
      {
        icon: '🎯',
        title: 'Problem',
        body: 'The enterprise platform had critically low accessibility compliance (~32%), a high volume of WCAG violations, and poor usability for assistive technology users — creating legal risk and excluding a significant segment of end users.',
      },
      {
        icon: '🔍',
        title: 'Research & Discovery',
        body: 'Conducted comprehensive accessibility audits using Axe DevTools, WAVE, and Lighthouse. Identified critical issues including insufficient colour contrast ratios, missing ARIA labels and roles, broken keyboard navigation paths, and inaccessible form patterns. Held stakeholder interviews and screen reader testing sessions with NVDA and JAWS.',
      },
      {
        icon: '📐',
        title: 'Wireframes & Architecture',
        body: 'Created accessible wireframes with a strong focus on logical DOM structure, predictable tab order and focus management, semantic HTML landmark regions, and inclusive form design patterns. Information architecture was restructured to support assistive technology navigation efficiently.',
      },
      {
        icon: '🎨',
        title: 'UI Design & Design System',
        body: 'Designed a scalable Figma Design System incorporating accessibility tokens — colour contrast-tested palettes, scalable typography hierarchy meeting WCAG 1.4.3/1.4.11, reusable accessible components with built-in ARIA annotations, and variant states covering focus, hover, error, and disabled interactions.',
      },
      {
        icon: '♿',
        title: 'Accessibility Approach',
        body: 'Implemented WCAG 2.1 AA compliance across all product surfaces. ARIA roles, live regions, and landmarks were applied systematically. Keyboard navigation was validated through manual testing. Screen reader compatibility was verified with NVDA and JAWS across Windows Chrome and Edge. Colour contrast and motion preferences (prefers-reduced-motion) were respected throughout.',
      },
      {
        icon: '🚀',
        title: 'Final Solution & Delivery',
        body: 'Shipped an accessible UI system across multiple enterprise product lines through close design–development collaboration. Delivered a comprehensive DesignOps workflow including accessibility checklists, component review processes, and a developer handoff system in Figma with ARIA specs embedded in every component annotation.',
      },
      {
        icon: '📊',
        title: 'Impact & Outcomes',
        body: 'WCAG compliance lifted from 32% to 98%. Accessibility violations reduced by 85%. Task completion rate improved by 28%. User engagement increased by 32%. Accessibility-related support tickets dropped by 67%. Core Web Vitals improved by 42%. Received Chairman Teams Award (PepsiCo 2022) and UI Star of the Quarter (2021).',
      },
    ],
  },
  {
    ...
    fullStudy: [
      {
        icon: '🎯',
        title: 'Problem',
        body: 'Slow page load times and inconsistent UI patterns were causing high drop-off rates and user dissatisfaction. The lack of a shared component library led to duplicated effort and diverging design standards across teams.',
      },
      {
        icon: '🔍',
        title: 'Research & Discovery',
        body: 'Analysed user behaviour through session recordings, heatmaps, and performance audits. Conducted moderated usability testing sessions identifying key friction points. Performance profiling revealed render-blocking resources and unoptimised asset delivery as primary culprits.',
      },
      {
        icon: '📐',
        title: 'Wireframes & Layout Optimisation',
        body: 'Redesigned key layouts to reduce cognitive load, prioritise above-the-fold content, and streamline interaction flows. Component wireframes were structured to support lazy loading and deferred rendering strategies.',
      },
      {
        icon: '🎨',
        title: 'UI Design & Component Library',
        body: 'Built a documented Figma Design System with consistent UI patterns, spacing tokens, and accessible colour pairs. Developed 30+ React components with WCAG 2.1 AA compliance, semantic HTML, and keyboard accessibility baked in from inception.',
      },
      {
        icon: '♿',
        title: 'Accessibility Considerations',
        body: 'Applied semantic HTML across all components, verified keyboard navigation flows, improved colour contrast ratios to meet WCAG 1.4.3, and ensured form elements had accessible labels and error messaging patterns.',
      },
      {
        icon: '🚀',
        title: 'Final Solution',
        body: 'Implemented code-splitting, lazy loading, and optimised image delivery to dramatically improve performance. The shared component library standardised UI delivery and reduced front-end build time significantly.',
      },
      {
        icon: '📊',
        title: 'Impact & Outcomes',
        body: 'Page load time reduced by 40%. Task completion rate improved by 22%. User satisfaction scores increased by 18%. Design-to-development cycle time cut by 32%. Lighthouse accessibility score sustained at 94+.',
      },
    ],
  },
  {
    ...
    fullStudy: [
      {
        icon: '🎯',
        title: 'Problem',
        body: 'Dabur India\'s consumer brand websites were experiencing high bounce rates and delivering an inconsistent user experience across 8+ device types. Multiple brand websites lacked UX coherence, slowing conversion and undermining brand equity for one of India\'s most recognised consumer goods companies.',
      },
      {
        icon: '🔍',
        title: 'Research & Discovery',
        body: 'Analysed user flow data, bounce rate patterns, and device usage distribution. Identified key drop-off points and page performance bottlenecks through Google Analytics and PageSpeed Insights. Studied competitor benchmarks in the FMCG digital space to identify experience gaps.',
      },
      {
        icon: '📐',
        title: 'Wireframes & UX Standardisation',
        body: 'Established standardised UX patterns across 4 distinct brand websites while preserving individual brand identity. Created responsive wireframes optimised for mobile-first delivery across 8+ device form factors including feature phones, tablets, and desktop.',
      },
      {
        icon: '🎨',
        title: 'UI Design & Responsive Components',
        body: 'Designed brand-aligned responsive UI components ensuring visual consistency within Dabur\'s brand guidelines. Built a reusable pattern library that accelerated delivery across multiple properties and maintained quality at scale.',
      },
      {
        icon: '♿',
        title: 'Accessibility & Readability',
        body: 'Improved readability through typography hierarchy refinements, enhanced colour contrast for outdoor lighting conditions on mobile, and responsive accessibility improvements ensuring content was legible across all screen sizes.',
      },
      {
        icon: '🚀',
        title: 'Final Solution',
        body: 'Delivered a unified design system and performance-optimised front-end across all brand properties. Implemented PageSpeed and Lighthouse audit recommendations, reducing page weight and improving critical rendering paths across high-traffic consumer portals.',
      },
      {
        icon: '📊',
        title: 'Impact & Outcomes',
        body: 'Improved user engagement and reduced bounce rates across brand properties collectively reaching 50M+ monthly users. Increased conversions across high-traffic consumer sites. Delivered responsive, accessible experiences across 8+ device types for one of India\'s largest consumer brands.',
      },
    ],
  },
  {
    ...
    fullStudy: [
      {
        icon: '🎯',
        title: 'Challenge',
        body: 'The challenge was to design an AI product/presentation in Figma UI that was visually compelling',
      },
      {
        icon: '🎨',
        title: 'Design System',
        body: 'Built a Figma Design System.',
      },
      
      {
        icon: '📊',
        title: 'Outcome',
        body: 'Delivered a fully Figma UI presentation that was visually compelling for production deployment.',
      },
    ],
  },
];
                ...
                <div className="case-card__detail-inner">
                  {cs.fullStudy ? (
                    ...
                    <div className="case-card__placeholder">
                      ...
                      <p>Contact me to receive a complete case study deck with wireframes, prototypes, and research findings.</p>
                      <a href="mailto:kamalpandey.dev@gmail.com" className="btn btn--primary">Request Full Deck</a>
                    </div>
                  )}
                </div>
              </div>
